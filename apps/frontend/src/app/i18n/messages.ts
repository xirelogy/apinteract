export const enUsMessages = {
  ...
  response: {
    ...
    connection: {
      ...
      authorized: "Trusted",
      authorizationUnknown: "Not observed",
      authorizationError: {
        self_signed_certificate: "Self-signed certificate",
        unknown_certificate_authority: "Unknown certificate authority",
        ...
        other_verification_error: "Other verification error",
      },
      protocol: "Protocol",
      cipher: "Cipher",
      alpn: "ALPN",
      ...
      certificatesIncomplete:
        "The proxy omitted {count} certificate(s) because the capture limit was reached.",
      leafCertificate: "Leaf certificate",
      chainCertificate: "Chain certificate {position}",
      ...
      unavailable: {
        disabled: "Detailed transport metadata collection was disabled.",
        unsupported:
          "Detailed transport metadata is not supported by this proxy.",
      },
      noData: "No connection details were observed.",
    },
