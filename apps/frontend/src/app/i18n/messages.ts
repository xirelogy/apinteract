export const enUsMessages = {
  ...
  response: {
    ...
    headers: "Headers",
    heading: "Response",
    htmlPreviewTitle: "Isolated HTML response preview",
    image: "Image",
    ...
    invalidJson: "The declared JSON response could not be parsed.",
    invalidXml: "The declared XML response could not be parsed.",
    json: "JSON",
    jsonBody: "Formatted JSON response body",
    ...
    xml: "XML",
    xmlBody: "Structured XML response body",
  },
  resource: {
